...
plot(pca_btm2[,2],pca_met2[,1],pch=19,col=scales::alpha(cols[cols_i],.7),
     ylab='metabolic PCA axis 1',xlab='RNA seq BTM axis 1')
#legend(x='topright',bty='n',legend=col_levs,pch=19,col=cols)
plot(pca_btm2[,4],pca_met2[,1],pch=19,col=scales::alpha(cols[cols_i],.7),
     ylab='metabolic PCA axis 1',xlab='RNA seq BTM axis 3')
legend(x='bottomleft',bty='n',legend=col_levs,pch=19,col=cols)
...
#legend(x='topright',bty='n',legend=col_levs,pch=19,col=cols)
plot(pca_btm2[,2],pca_met2[,1],pch=19,col=scales::alpha(cols[cols_i],.7),
     ylab='metabolic PCA axis 1',xlab='RNA seq BTM axis 2')
legend(x='topright',bty='n',legend=col_levs,pch=19,col=cols)
...
#legend(x='topright',bty='n',legend=col_levs,pch=19,col=cols)
plot(pca_btm2[,4],pca_met2[,1],pch=19,col=scales::alpha(cols[cols_i],.7),
     ylab='metabolic PCA axis 1',xlab='RNA seq BTM axis 4')
#legend(x='bottomleft',bty='n',legend=col_levs,pch=19,col=cols)
